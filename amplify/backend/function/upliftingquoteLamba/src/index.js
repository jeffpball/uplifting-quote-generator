/* Amplify Params - DO NOT EDIT
	API_UPLIFTINGQUOTEGENERA_GRAPHQLAPIIDOUTPUT
	API_UPLIFTINGQUOTEGENERA_QUOTEAPPDATATABLE_ARN
	API_UPLIFTINGQUOTEGENERA_QUOTEAPPDATATABLE_NAME
	ENV
	REGION
Amplify Params - DO NOT EDIT */
...
async function updateQuoteDDBObject() {
    const quoteTableName = process.env.API_UPLIFTINGQUOTEGENERA_QUOTEAPPDATATABLE_NAME;
    ...
    async function getRandomQuote(apiURLInput) {
        ...
        const svgImage = `
          <svg width="${width}" height="${height}">
              ...
              <text x="${width / 2}" y="${
          height - 10
        }" class="footerStyles">Developed by @jeffpball | Quotes from ZenQuotes.io</text>
          </svg>
        `;
